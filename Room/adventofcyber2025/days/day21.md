...
This room introduces **static malware analysis** using a malicious **HTA file** disguised as a legitimate survey. The goal is to reverse-engineer the file, understand its behaviour, and uncover how **King Malhare** compromised Wareville’s systems.
...
Wareville’s systems process thousands of files daily — PDFs, DOCX files, spreadsheets, and executables. Among these, **HTA files** can look harmless but may hide malicious intent.
...
## 🧠 Task 2 – Understanding HTA Files
...
🧪 Objects Used (Indicators of Malicious Activity)
...
```
Base64 – hides payload
```
ROT13 – second-layer obfuscation
```
...
Encoding ≠ encryption — always decode
