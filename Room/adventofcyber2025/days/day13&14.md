...
wide / ascii – Unicode & ASCII

xor – XOR-encoded strings

base64 / base64wide – Base64-encoded data

⚙️ 5. Conditions Logic
...
🧪 6. Practical Task – TBFC Message Hunt
...
🛡️ 8. Blue Team Takeaways
YARA enables proactive threat hunting

Detects malware variants beyond signatures

Rules are shareable and customizable

Essential tool for SOC and DFIR teams

✅ Day 13 completed — mastering YARA-based malware detection.
...
⚠️ 4. Container Escape via Docker Socket
...
🧪 5. Practical Walkthrough Summary
Enumerated running containers using Docker

Accessed uptime-checker container

Discovered Docker socket access

Escaped into privileged deployer container
...
✅ Day 14 completed — understanding Docker security and container escapes.

🎄 Advent of Cyber 2025 — Days 13 & 14 successfully completed.
